...
::: code-group
```js  [ESModule]
import { validation } from '@wgl-m/utils';
// import validation from '@wgl-m/utils/es/validation.mjs';
```
```js  [CommonJs]
...
```html  [ESModule]
<script type="module">
  import { validation } from '@wgl-m/utils/main.mjs';
  // import validation from '@wgl-m/utils/es/validation.mjs';
</script>
```
```html  [ES5]
...
```js  [源码]
// src/validation.js
<!-- @include: ../../../packages/utils/src/validation.ts -->
```

```js  [ESModule]
// dist/es/validation.mjs
<!-- @include: ../../../packages/utils/dist/es/validation.mjs -->
```
:::
